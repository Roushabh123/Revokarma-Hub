<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Index.aspx.cs" Inherits="Sample" %>
...
<body>
    ...
    <nav class="navbar navbar-default" role="navigation">  
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- TEXT BASED LOGO -->
          <p></p>
           <img src = "assets/images/RKH1.png" alt="" height=80px; width =350px; /> 
          ...
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="#">Blog Single with Left Sidebar</a></li>
                <li><a href="#">Blog Single with Right Sidebar</a></li>
                <li><a href="#">Blog Single with out Sidebar</a></li>           
              </ul>
            </li>
  ...
  <div class="main-slider">
      <div class="single-slide">
        <img src="assets/images/portfolio/bg33.png" alt="img">
      ...
      <div class="row">
              <div class="col-md-4 col-sm-6">
                <div class="single-feature wow zoomIn">
                  ...
                  <p align="justify">Businesses today face an unexplained struggle in engaging competent and accomplished work force. Studies suggest that the number of skilled personnel being groomed today, with most sought after professional capabilities across the globe.</p>
                </div>
              </div>
              <div class="col-md-4 col-sm-6">
                <div class="single-feature wow zoomIn">
                  ...
                  <p align="justify"> But the paradox is that an alarming percentage of these highly able resources remain unemployed, creating a vicious cycle.The world moves at a new pace today. Dynamics defining work and work place change along with employable.</p>
                </div>
              </div>
              <div class="col-md-4 col-sm-6">
                <div class="single-feature wow zoomIn">
                  ...
                  <p align="justify"> Expectations of businesses from their workforce metamorphose as well, and their demands of unfaltering, commitment, continuous support, and reliability from skilled personnel reaches a pinnacle of sorts.</p>
                </div>
              </div>
              <div class="col-md-4 col-sm-6">
                <div class="single-feature wow zoomIn">
                  ...
                  <p align="justify">The boundaries between work place and personal lives become thinner every passing day making work – life integration complete for the emerging new generation of a smart workforce.</p>
                </div>
              </div>
              <div class="col-md-4 col-sm-6">
                <div class="single-feature wow zoomIn">
                  ...
                  <p align="justify">A whole new populace driven by passion, creativity and discipline, superlative standards set on their own accord is on the rise, waiting to be tapped by the befitting mentors.</p>
                </div>
              </div>
              <div class="col-md-4 col-sm-6">
                <div class="single-feature wow zoomIn">
                  ...
                  <p>Heralding a nouvé ideology to the benefit of both; businesses and skilled individuals, we offer you a unique Cloud sourcing solution delivering optimized business processes executed by skilled humans on the Cloud.</p>
                </div>
              </div>
              <div class="col-md-4 col-sm-6">
                <div class="single-feature wow zoomIn">
                  <i class="fa fa-leaf feature-icon"></i>
                  <h4 class="feat-title">Creative Design</h4>
                  <p align="justify">We offer the scalability and flexibility of the Cloud in our virtual offices erasing the boundaries limited to the nations; united by the oneness created by the virtual world, bound by communication and technology.</p>
                </div>
              </div>
              <div class="col-md-4 col-sm-6">
                <div class="single-feature wow zoomIn">
                  <i class="fa fa-mobile feature-icon"></i>
                  <h4 class="feat-title">Responsive Layouts</h4>
                  <p align="justify">We build Cloud based human business process optimizations to steer your workflows through the correct milestones right from inception to culmination, with promising returns on investments.</p>
                </div>
              </div>
              <div class="col-md-4 col-sm-6">
                <div class="single-feature wow zoomIn">
                  <i class="fa fa-thumbs-o-up feature-icon"></i>
                  <h4 class="feat-title">Great Features</h4>
                  <p align="justify">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="title-area">
           ...
           <p align="justify"> RevoKarmaHub, sets out to transform the world with unique ideas. RevoKarmahub's vision is to provide quality products & services that exceeds the expectations of our esteemed customers. We firmly believe that our customers are the reason for our existence, and greatly respect the trust that they place in us. We grow through creativity and innovation. We integrate honesty, integrity and business ethics into all aspects of our business functioning.</p>
            <p align="justify"> Our mission is to build long term relationships with our customers. We strive towards delighting our customers at every opportunity through exceptional customer service. Our future looks bright as we continue developing a strong base of key customers and increasing the assets and investments of the company.</p>
          </div>
        </div>
        <div class="col-md-12">
            ...
            <ul class="clients-brand-slide">
              <li class="col-md-3">
                <div class="single-brand">
                  <img src="assets/images/Quality.PNG" alt="img">
                </div>
              </li>
              <li class="col-md-3">
                <div class="single-brand">
                  <img src="assets/images/Wallero.PNG" alt="img">
                </div>
              </li>
              <li class="col-md-3">
                <div class="single-brand">
                  <img src="assets/images/fleetzen.PNG" alt="img">
                </div>
              </li>
              <li class="col-md-3">
                <div class="single-brand">
                  <img src="assets/images/abc.png" alt="img">
                </div>
              </li>
               <li class="col-md-3">
                <div class="single-brand">
      ...
      <div class="row">
        <div class="col-md-6 col-sm-6">
          <div class="footer-left">
            <p>Copyright © 2016 revokarmahub. All rights reserved.</p>
          </div>
        </div>
        <div class="col-md-6 col-sm-6">
          <div class="footer-right">
            <a target="_blank" href="https://www.facebook.com/RevokarmaHub-Software-and-Services-Pvt-Ltd-830613677043716/?ref=aymt_homepage_panel"><i class="fa fa-facebook"></i></a>
            <a target="_blank" href="https://twitter.com/REVOKARMAHUB"><i class="fa fa-twitter"></i></a>
            <a href="#"><i class="fa fa-google-plus"></i></a>
            <a target="_blank" href="https://www.linkedin.com/company/revo-karmahub-software-and-services-pvt-ltd.?trk=biz-companies-cym"><i class="fa fa-linkedin"></i></a>
